...
const FormContainer = styled.div`
  ...
  form {
    ...
    flex-direction: column;
    gap: 2rem;
    background-color: #fff; /* Change background color to black */
    border-radius: 2rem;
    padding: 5rem;
  }
  input {
    ...
    padding: 1rem;
    border: 0.1rem solid #000; /* Change border color to white */
    border-radius: 0.4rem;
    color: #000; /* Change text color to white */
    width: 100%;
    font-size: 1rem;
    &:focus {
      border: 0.1rem solid #000; /* Change border color on focus to black */
      outline: none;
      color:#000
    }
  }
